...
minimapTags: docs overview architecture repo runtime docs-app build-pipeline
order: 3
---
...
packages/
  ...
  dom/        DOM rendering, interaction systems, and binding targets
...
- DOM input/value synchronization built on binding targets + `DOMBinding`
...
5. module bundles for live editor imports (`dist/playground/modules`)
6. generated `.d.ts` bundle for live editor Monaco typing (`dist/playground/types`)
7. static page rendering + search index generation
